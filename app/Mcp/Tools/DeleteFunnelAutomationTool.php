...
class DeleteFunnelAutomationTool extends Tool
{
    use ScopesToMarketer;

    protected string $name = 'delete_funnel_automation';

    protected string $description = <<<'MARKDOWN'
        Delete a funnel automation (and its actions/logs). Provide the
        funnel_uuid and automation_id (from list_funnel_automations).
        MARKDOWN;
    ...
    public function schema(JsonSchema $schema): array
    {
        return [
            ...
            'automation_id' => $schema->integer()->description('The id of the automation to delete.')->required(),
        ];
    }
}
