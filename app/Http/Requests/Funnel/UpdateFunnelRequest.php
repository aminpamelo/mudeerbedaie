...
class UpdateFunnelRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'settings.pixel_settings.facebook.library_pixel_id' => ['nullable', 'integer'],
            'settings.pixel_settings.google' => ['nullable', 'array'],
            'settings.pixel_settings.google.enabled' => ['nullable', 'boolean'],
            'settings.pixel_settings.google.ga4_measurement_id' => ['nullable', 'string', 'max:50'],
            'settings.pixel_settings.google.ads_conversion_id' => ['nullable', 'string', 'max:50'],
            'settings.pixel_settings.google.ads_purchase_label' => ['nullable', 'string', 'max:100'],
            ...
            'shipping_settings.enabled' => ['nullable', 'boolean'],
            'shipping_settings.mode' => ['nullable', 'string', 'in:general,custom'],
            'shipping_settings.semenanjung_cost' => ['nullable', 'numeric', 'min:0'],
            'shipping_settings.sabah_sarawak_cost' => ['nullable', 'numeric', 'min:0'],
            'shipping_settings.custom_costs' => ['nullable', 'array'],
            'shipping_settings.custom_costs.stripe' => ['nullable', 'array'],
            'shipping_settings.custom_costs.stripe.semenanjung' => ['nullable', 'numeric', 'min:0'],
            'shipping_settings.custom_costs.stripe.sabah_sarawak' => ['nullable', 'numeric', 'min:0'],
            'shipping_settings.custom_costs.bayarcash_fpx' => ['nullable', 'array'],
            'shipping_settings.custom_costs.bayarcash_fpx.semenanjung' => ['nullable', 'numeric', 'min:0'],
            'shipping_settings.custom_costs.bayarcash_fpx.sabah_sarawak' => ['nullable', 'numeric', 'min:0'],
            'shipping_settings.custom_costs.cod' => ['nullable', 'array'],
            'shipping_settings.custom_costs.cod.semenanjung' => ['nullable', 'numeric', 'min:0'],
            'shipping_settings.custom_costs.cod.sabah_sarawak' => ['nullable', 'numeric', 'min:0'],
