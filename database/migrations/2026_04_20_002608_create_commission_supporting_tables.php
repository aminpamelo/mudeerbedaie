...
return new class extends Migration
{
     ...
     * Each create is guarded by hasTable so the migration is idempotent on
     * production databases where a prior partial run may have left tables in
     * place without the migrations-table row.
     */
    public function up(): void
    {
        if (! Schema::hasTable('live_session_gmv_adjustments')) {
        ...
        if (! Schema::hasTable('live_host_payroll_runs')) {
        ...
        if (! Schema::hasTable('live_host_payroll_items')) {
        ...
        if (! Schema::hasTable('tiktok_live_reports')) {
