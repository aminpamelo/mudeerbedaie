...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('classes', function (Blueprint $table) {
            ...
            $table->enum('shipment_frequency', ['monthly', 'per_session', 'one_time', 'custom'])->default('monthly')->after('enable_document_shipment');
            ...
            $table->integer('shipment_quantity_per_student')->default(1)->after('shipment_warehouse_id');
