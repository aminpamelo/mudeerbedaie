    ...
    public function run(): void
    {
        ...
        for ($i = 0; $i < 8; $i++) {
            ...
            $data[] = [
                ...
                'action' => 'approved',
                'action_reason' => $actionReasons['approved'][array_rand($actionReasons['approved'])],
                'action_date' => now()->subDays(rand(3, 15)),
        ...
        for ($i = 0; $i < 3; $i++) {
            ...
            $data[] = [
                ...
                'refund_amount' => $order ? $order->total_amount : rand(50, 500),
                'action' => 'rejected',
                'action_reason' => $actionReasons['rejected'][array_rand($actionReasons['rejected'])],
                'action_date' => now()->subDays(rand(5, 20)),
                'processed_by' => $admin?->id,
                'tracking_number' => null,
                'account_number' => null,
                'account_holder_name' => null,
