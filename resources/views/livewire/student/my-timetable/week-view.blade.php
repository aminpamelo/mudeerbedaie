                ...
                <div class="p-2 min-h-[200px] space-y-1">
                    ...
                    @forelse($sortedItems as $item)
                        @if($item['type'] === 'session')
                            ...
                            <div 
                                class="group rounded-lg p-2 text-xs transition-all duration-200 hover:shadow-md
                                       @switch($session->status)
                                           ...
                                           @case('ongoing')
                                               ...
                                               @break
                                           @case('completed')
                                               bg-gray-100 dark:bg-gray-900/30 border border-gray-200 dark:border-gray-800 hover:bg-gray-200 dark:hover:bg-gray-900/50 cursor-pointer
                                               @break
                                           @case('cancelled')
                            ...
                            >
                                ...
                                {{-- Session Course --}}
                                <div class="text-gray-600 dark:text-gray-400 truncate" title="{{ $session->class->course->name }}">
                                    {{ $session->class->course->name }}
                                </div>
                                
                                {{-- Teacher --}}
                                <div class="text-gray-500 dark:text-gray-500 truncate" title="{{ $session->class->teacher->user->name }}">
                                ...
                                {{-- Click to view indication for completed sessions --}}
                                @if($session->status === 'completed')
                        ...
                        @else
                            ...
                            <div class="rounded-lg p-2 text-xs bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-200 dark:border-indigo-800">
                                {{-- Scheduled Time --}}
                                ...
                                {{-- Course Name --}}
                                <div class="text-indigo-600 dark:text-indigo-400 truncate" title="{{ $class->course->name }}">
                                    {{ $class->course->name }}
                                </div>
                                
                                {{-- Teacher --}}
                                <div class="text-indigo-500 dark:text-indigo-400 truncate" title="{{ $class->teacher->user->name }}">
                    ...
                    <div class="p-3 min-h-[300px] space-y-2">
                        ...
                        @forelse($sortedItems as $item)
                            @if($item['type'] === 'session')
                                ...
                                @php $session = $item['session']; @endphp
                                <div 
                                    class="group rounded-lg p-3 text-sm transition-all duration-200 hover:shadow-md
                                           @switch($session->status)
                                               @case('scheduled')
                                                   bg-blue-100 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-800 hover:bg-blue-200 dark:hover:bg-blue-900/50
                                                   @break
                                ...
                                >
                                    ...
                                    <div class="text-gray-600 dark:text-gray-400 text-xs truncate mb-1" title="{{ $session->class->course->name }}">
                                        {{ $session->class->course->name }}
                                    </div>
                                    
                                    <div class="text-gray-500 dark:text-gray-500 text-xs truncate mb-2" title="{{ $session->class->teacher->user->name }}">
                                        {{ $session->class->teacher->user->name }}
                                    </div>
                            ...
                            @else
                                {{-- Scheduled Slot Without Session --}}
                                @php $class = $item['class']; @endphp
                                <div class="rounded-lg p-3 text-sm bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-200 dark:border-indigo-800">
                                    ...
                                    <div class="text-indigo-600 dark:text-indigo-400 text-xs truncate mb-1" title="{{ $class->course->name }}">
                                        {{ $class->course->name }}
                                    </div>
                                    
                                    <div class="text-indigo-500 dark:text-indigo-400 text-xs truncate mb-2" title="{{ $class->teacher->user->name }}">
                                        {{ $class->teacher->user->name }}
                                    </div>
