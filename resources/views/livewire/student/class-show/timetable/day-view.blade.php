...
<div class="space-y-1">
    @forelse($timeSlots as $slot)
        <div class="flex items-start gap-4 p-3 border border-gray-200 dark:border-gray-700 rounded-lg {{ $slot['sessions']->count() > 0 ? 'bg-white dark:bg-gray-800' : 'bg-gray-50 dark:bg-gray-900' }}">
            {{-- Time Label --}}
                            ...
                            >
                                ...
                                @if($session->status === 'ongoing')
                                    ...
                                    " x-destroy="timer && clearInterval(timer)">
                                        <div class="bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-800 rounded-lg px-4 py-2 inline-flex items-center gap-2">
                                            <div class="text-sm font-mono font-semibold text-green-700 dark:text-green-300" x-text="formatTime(elapsedTime)">
                                            </div>
                                            <div class="text-xs text-green-600 dark:text-green-400">Session in progress</div>
                                        </div>
                                    </div>
                                @endif
                            </div>
                                ...
                                class="rounded-lg p-3 border
                                       @switch($session->status)
                                           @case('scheduled')
                                               ...
                                               @break
                                           @case('ongoing')
                                               bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800 animate-pulse
                                               @break
                                           @case('completed')
