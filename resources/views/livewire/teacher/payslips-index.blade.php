    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <flux:card class="p-4">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-blue-600">RM{{ number_format($statistics['total_earnings'], 2) }}</div>
        ...
        <flux:card class="p-4">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-green-600">RM{{ number_format($statistics['paid_earnings'], 2) }}</div>
                    <div class="text-sm text-gray-600">Paid Out</div>
                </div>
        ...
        <flux:card class="p-4">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-yellow-600">RM{{ number_format($statistics['pending_earnings'], 2) }}</div>
        ...
        <flux:card class="p-4">
            <div class="flex items-center justify-between">
                <div>
                    <div class="text-2xl font-bold text-purple-600">{{ $statistics['total_sessions'] }}</div>
                ...
                <flux:card class="p-6 hover:shadow-lg transition-all duration-200">
                    <div class="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                        ...
                        <div class="flex flex-col items-end gap-3 lg:min-w-fit">
                            <div class="text-2xl font-bold text-green-600  bg-green-50 /20 px-4 py-2 rounded-lg">
