...
<body>
    ...
    <div class="address-section">
        <table class="address-table">
            <tr>
                    ...
                    @if($order->agent?->address)
                        ...
                        <div class="address-detail">
                            @if(!empty($agentAddress['street']))
                                {{ strtoupper($agentAddress['street']) }},<br>
                            @endif
                            @if(!empty($agentAddress['postal_code']) || !empty($agentAddress['city']))
                                {{ strtoupper($agentAddress['postal_code'] ?? '') }} {{ strtoupper($agentAddress['city'] ?? '') }},<br>
                            @endif
                            @if(!empty($agentAddress['state']))
                                {{ strtoupper($agentAddress['state']) }}
                            @endif
                        </div>
                    @endif
                ...
                <!-- Delivery Address (same as agent for agent orders) -->
                <td class="address-column">
    ...
    <div class="info-section">
        <table class="info-table">
            <tr>
                <th style="width: 18%;">Agent Account</th>
                <th style="width: 15%;">Agent Code</th>
    ...
    <div class="payment-section">
        ...
        <div class="payment-value">{{ $order->agent?->payment_terms ?? 'Immediate' }}</div>
    </div>
            ...
            <tr>
                <td class="signature-column">
                    <div class="signature-line">
                        <div class="signature-label">Agent/Company Stamp & Signature</div>
                    </div>
                </td>
