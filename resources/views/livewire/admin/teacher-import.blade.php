...
<div class="max-w-6xl mx-auto">
    <div class="mb-6">
        <flux:heading size="xl">Import Teachers</flux:heading>
        <flux:text class="mt-2">Upload a CSV file to import multiple teachers at once</flux:text>
    </div>
                        ...
                        <div class="flex">
                            ...
                            <div class="text-sm">
                                ...
                                <ul class="mt-2 text-blue-700 list-disc list-inside space-y-1">
                                    <li>Upload a CSV file with teacher information</li>
                                    <li><strong>Required columns:</strong> name, phone</li>
                                    <li><strong>Optional columns:</strong> email, ic_number, joined_at, status, bank_account_holder, bank_account_number, bank_name</li>
                                    <li>If phone/email/IC number exists, existing teacher will be updated</li>
                                    <li>Teacher ID will be auto-generated if not provided</li>
                                    <li>Default password will be set to 'password123' for new accounts</li>
                                    <li>Auto-generated email if not provided (teacher{phone}@example.com)</li>
                                    <li>Bank account numbers are encrypted for security</li>
                    ...
                    <form wire:submit.prevent="uploadCsv">
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between">
                                <flux:button href="{{ route('teachers.index') }}" variant="ghost">
                                    Cancel
                                </flux:button>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @foreach($previewData as $row)
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-4 py-4 text-sm text-gray-900">{{ $row['data']['bank_name'] ?? 'N/A' }}</td>
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                        <div class="bg-green-50 border border-green-200 rounded-lg p-4 text-center">
                            ...
                            <p class="text-sm text-green-700">New Teachers</p>
                        </div>

                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4 text-center">
                            <p class="text-3xl font-bold text-blue-900">{{ $importResults['updated'] ?? 0 }}</p>
                            <p class="text-sm text-blue-700">Updated Teachers</p>
                        </div>
                    ...
                    <div class="flex justify-center space-x-4">
                        <flux:button href="{{ route('teachers.index') }}" variant="primary">
                            View Teachers
                        </flux:button>
