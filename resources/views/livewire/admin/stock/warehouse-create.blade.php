...
new class extends Component
{
    ...
    public function save(): void
    {
        ...
        $this->redirect(route('warehouses.show', $warehouse));
    }
}; ?>
...
<div>
    <div class="mb-6 flex items-center justify-between">
        <div>
            <flux:heading size="xl">Create Warehouse</flux:heading>
            <flux:text class="mt-2">Add a new warehouse location</flux:text>
        </div>
    ...
    <form wire:submit="save" class="space-y-6">
        ...
        <div class="flex items-center justify-end space-x-3 border-t border-gray-200 pt-6">
            <flux:button variant="outline" href="{{ route('warehouses.index') }}">
                Cancel
            </flux:button>
