...
new class extends Component {
    ...
    {
        return [
            'parentCategories' => ProductCategory::active()->ordered()->get(),
        ];
    }
    ...
    public function save(): void
    {
        ...
        $this->redirect(route('product-categories.show', $category));
    }
}; ?>
...
<div>
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <flux:text class="mt-2">Add a new product category</flux:text>
        </div>
    ...
    <form wire:submit="save" class="max-w-2xl space-y-6">
        ...
        <div class="flex items-center justify-end space-x-3 border-t border-gray-200 pt-6">
            <flux:button variant="outline" href="{{ route('product-categories.index') }}">
                Cancel
            </flux:button>
