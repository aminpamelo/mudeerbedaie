            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6">
                ...
                <dl class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">{{ $attribute->label }}</dd>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <dd class="mt-1 text-sm text-gray-900">{{ $attribute->created_at->format('M j, Y g:i A') }}</dd>
                    </div>
                    <div>
                        <dt class="text-sm font-medium text-gray-500">Last Updated</dt>
                        <dd class="mt-1 text-sm text-gray-900">{{ $attribute->updated_at->format('M j, Y g:i A') }}</dd>
                    </div>
                </dl>
                ...
                @if($attribute->description)
                    <div class="mt-6">
                        ...
                        <dd class="mt-2 text-sm text-gray-900">{{ $attribute->description }}</dd>
                    </div>
                @endif
            </div>
                    ...
                    <div class="space-y-4">
                        @foreach($attribute->productVariants->take(10) as $variant)
                            <div class="flex items-center justify-between border-b border-gray-100 pb-3 last:border-b-0 last:pb-0">
                                <div>
                                    <div class="font-medium text-gray-900">{{ $variant->product->name }}</div>
            ...
            @else
                <div class="rounded-lg border border-gray-200 bg-white p-6">
                    <div class="text-center">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">Not used yet</h3>
                        <p class="mt-1 text-sm text-gray-500">This attribute hasn't been used in any product variants yet.</p>
                    </div>
                </div>
            @endif
        </div>
            ...
            <div class="rounded-lg border border-gray-200 bg-white p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="font-semibold text-gray-900">{{ ucfirst($attribute->type) }}</span>
                    </div>
                    <div class="flex items-center justify-between">
                        <span class="text-sm text-gray-500">Variants Using</span>
                        <span class="font-semibold text-gray-900">{{ $attribute->productVariants->count() }}</span>
                    </div>
                    @if($attribute->values)
                        <div class="flex items-center justify-between">
                            <span class="text-sm text-gray-500">Available Values</span>
                            <span class="font-semibold text-gray-900">{{ count($attribute->values) }}</span>
                        </div>
                    @endif
                    <div class="flex items-center justify-between">
