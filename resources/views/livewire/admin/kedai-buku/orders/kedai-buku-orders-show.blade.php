                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <flux:button wire:click="updateStatus('pending')" size="sm" :variant="$order->status === 'pending' ? 'filled' : 'outline'">
                                Pending
                            </flux:button>
                            <flux:button wire:click="updateStatus('processing')" size="sm" :variant="$order->status === 'processing' ? 'primary' : 'outline'">
                                Processing
                            </flux:button>
                            <flux:button wire:click="updateStatus('delivered')" size="sm" :variant="$order->status === 'delivered' ? 'primary' : 'outline'" :color="$order->status === 'delivered' ? 'green' : null">
                                Delivered
                            </flux:button>
                    ...
                    <div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            <flux:button wire:click="updatePaymentStatus('pending')" size="sm" :variant="($order->payment_status ?? 'pending') === 'pending' ? 'filled' : 'outline'">
                                Pending
                            </flux:button>
                            <flux:button wire:click="updatePaymentStatus('partial')" size="sm" :variant="$order->payment_status === 'partial' ? 'primary' : 'outline'">
                                Partial
                            </flux:button>
                            <flux:button wire:click="updatePaymentStatus('paid')" size="sm" :variant="$order->payment_status === 'paid' ? 'primary' : 'outline'" :color="$order->payment_status === 'paid' ? 'green' : null">
                                Paid
                            </flux:button>
                        </div>
                    </div>
