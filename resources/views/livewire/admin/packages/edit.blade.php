...
new class extends Component
{
    ...
    public function mount(Package $package): void
    {
        ...
        $this->fulfillment_type = $package->fulfillment_type ?? 'physical';
        $this->external_system_id = $package->provisioningExternalSystemId() ?? '';
        $this->external_plan = $package->provisioningPlan() ?? '';
    ...
    {
        $metadata = $this->package->metadata ?? [];
