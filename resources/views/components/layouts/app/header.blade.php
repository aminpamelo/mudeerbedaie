    ...
    <body class="min-h-screen bg-white">
        ...
        <flux:sidebar stashable sticky class="lg:hidden border-e border-zinc-200 bg-zinc-50">
            ...
            <flux:navlist variant="outline">
                ...
                <flux:navlist.group :heading="__('Financial')">
                ...
                <flux:navlist.group :heading="__('Payments')">
                    ...
                    <flux:navlist.item icon="building-library" :href="route('admin.bank-transfers')" :current="request()->routeIs('admin.bank-transfers*')" wire:navigate>{{ __('Bank Transfers') }}</flux:navlist.item>
                </flux:navlist.group>
                
                <flux:navlist.group :heading="__('System')">
                    <flux:navlist.item icon="cog-6-tooth" :href="route('admin.settings.general')" :current="request()->routeIs('admin.settings.*')" wire:navigate>{{ __('Settings') }}</flux:navlist.item>
                </flux:navlist.group>
                @endif
                
                @if(auth()->user()->isStudent())
                <flux:navlist.group :heading="__('My Account')">
                    <flux:navlist.item icon="document" :href="route('student.invoices')" :current="request()->routeIs('student.invoices*')" wire:navigate>{{ __('My Invoices') }}</flux:navlist.item>
                    <flux:navlist.item icon="currency-dollar" :href="route('student.payments')" :current="request()->routeIs('student.payments*')" wire:navigate>{{ __('Payment History') }}</flux:navlist.item>
