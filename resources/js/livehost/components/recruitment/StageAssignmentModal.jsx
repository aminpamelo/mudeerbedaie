        ...
        {applicant.phone && (
          <div className="mb-4 flex items-center justify-between gap-2 rounded-lg border border-[#EAEAEA] bg-[#FAFAFA] px-3 py-2">
            <div className="min-w-0">
              ...
              <div className="truncate font-mono text-[13px] text-[#0A0A0A]">{applicant.phone}</div>
            </div>
            <div className="flex shrink-0 items-center gap-1.5">
              <a
                ...
                className="inline-flex items-center gap-1 rounded-md bg-[#25D366] px-2.5 py-1.5 text-[12px] font-medium text-white hover:bg-[#1FB855]"
              >
                <WhatsAppIcon className="h-3.5 w-3.5" />
                WhatsApp
              </a>
              <a
                href={`tel:${String(applicant.phone).replace(/[^\d+]/g, '')}`}
                className="inline-flex items-center gap-1 rounded-md border border-[#EAEAEA] bg-white px-2.5 py-1.5 text-[12px] font-medium text-[#0A0A0A] hover:bg-[#F5F5F5]"
              >
