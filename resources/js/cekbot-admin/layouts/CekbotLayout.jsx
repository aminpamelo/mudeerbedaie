...
import { Bot, Smartphone, MessageCircle, Users, Zap, Package, Megaphone, BarChart3, Settings, Menu, X, ArrowLeft, Workflow } from 'lucide-react';
...
const NAV = [
  ...
  { label: 'Flows', href: '/admin/cekbot/flows', icon: Workflow },
