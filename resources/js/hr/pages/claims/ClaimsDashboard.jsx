...
const STAT_CARDS = [
    { key: 'pending', label: 'Pending Requests', icon: Clock, accent: 'amber' },
    { key: 'approved_this_month', label: 'Approved This Month', icon: CheckCircle, accent: 'emerald' },
    { key: 'total_amount_this_month', label: 'Total Amount (Month)', icon: DollarSign, accent: 'sky', isCurrency: true },
    { key: 'pending_amount', label: 'Pending Amount', icon: FileText, accent: 'violet', isCurrency: true },
];
        ...
        <div>
            ...
            <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-3">
                <Card className="lg:col-span-2">
                    <CardContent className="p-6">
                        <h3 className="mb-4 text-lg font-semibold text-slate-900">Pending Approvals</h3>
                        {pendingLoading ? (
                            <SkeletonTable />
                            ...
                            <div className="flex flex-col items-center justify-center py-12 text-center">
                                ...
                                <p className="mt-1 text-xs text-slate-400">No pending claim requests.</p>
                            </div>
                        ) : (
                            <Table>
                                <TableHeader>
                ...
                <Card>
                    <CardContent className="p-6">
                        <h3 className="mb-4 text-lg font-semibold text-slate-900">Claims by Type</h3>
                    ...
                    {selectedRequest && (
                        <div className="space-y-3 text-sm">
                            <div className="flex justify-between">
                                <span className="text-slate-500">Claim No.</span>
                            ...
                            <div className="flex justify-between">
                                ...
                                <span className={cn('rounded-full px-2 py-0.5 text-xs font-medium', STATUS_BADGE_CLASS[selectedRequest.status] || 'bg-slate-100 text-slate-600')}>
