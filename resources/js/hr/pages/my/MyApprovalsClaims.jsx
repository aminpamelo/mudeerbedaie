        ...
        <div className="mx-auto max-w-4xl p-4 lg:p-6">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="mt-1 text-sm text-slate-600">
                                        ...
                                        {req.approved_amount != null &&
                                            ` → approved RM ${Number(req.approved_amount).toFixed(2)}`}
                                    </p>
            ...
            <Dialog open={!!approveDialog} onOpenChange={() => setApproveDialog(null)}>
                <DialogContent>
                    ...
                    <p className="text-sm text-slate-500">
                        Approving claim from <strong>{approveDialog?.name}</strong>. Requested: RM{' '}
                        {Number(approveDialog?.amount ?? 0).toFixed(2)}
                    </p>
                    <div className="mt-2">
                    ...
                    <DialogFooter>
                        ...
                        <button
                            onClick={() =>
                                approveMut.mutate({ id: approveDialog.id, amount: parseFloat(approvedAmount) })
                            }
