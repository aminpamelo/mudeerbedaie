    ...
    const renderSaleDetail = () => {
        ...
        return (
            <div className="space-y-3">
                ...
                <div className="border-t border-gray-100 pt-3">
                    <button
                        onClick={() => saleApi.receiptPdf(selectedSale.id)}
                        className="w-full inline-flex items-center justify-center gap-2 px-3 py-2 text-sm font-medium text-blue-600 bg-blue-50 hover:bg-blue-100 rounded-lg border border-blue-200 transition-colors"
                    >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="bg-white border-b border-gray-200 px-4 lg:px-6 py-3 shrink-0">
                <div className="flex items-center gap-2 lg:gap-3 overflow-x-auto pb-1 lg:pb-0">
                    ...
                    <button
                        ...
                        disabled={exporting}
                        className="ml-auto px-3 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors shrink-0 disabled:opacity-50 flex items-center gap-1.5"
                    >
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                                    ...
                                    <table className="w-full">
                                        <thead>
                                            <tr className="bg-gray-50 border-b border-gray-200">
                                                ...
                                                <th className="text-center px-4 py-3 text-xs font-semibold text-gray-500 uppercase">Receipt</th>
                                            </tr>
                                        </thead>
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        ...
                                                        <td className="px-4 py-3 text-center">
                                                            <button
                                                                onClick={(e) => { e.stopPropagation(); saleApi.receiptPdf(sale.id); }}
