      ...
      <div className="p-4">
        ...
        {refund.reason && (
          <div className="mt-3 rounded-xl bg-violet-50/50 p-3">
            <p className="text-[11px] font-semibold text-muted">Reason</p>
        ...
        {refund.action_reason && (
          <div className={cn('mt-3 rounded-xl p-3', refund.action_is_approved ? 'bg-emerald-50' : 'bg-red-50')}>
            <p className={cn('text-[11px] font-semibold', refund.action_is_approved ? 'text-emerald-600' : 'text-red-600')}>Admin Response</p>
...
export default function RefundRequests() {
  ...
  const hero = (
    <PageHeader tag="Refund Requests" title="Refund Requests" subtitle="View and manage your refund requests">
      <HeroStat icon={RefreshCw} label="Total" value={stats.total} />
    </PageHeader>
  );
